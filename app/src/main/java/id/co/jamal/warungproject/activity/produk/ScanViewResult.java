...
public class ScanViewResult extends LinearLayout {
    ...
    public ScanViewResult(Context context) {
        super(context);
        Init();
    }

    public ScanViewResult(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        Init();
    }

    public ScanViewResult(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
